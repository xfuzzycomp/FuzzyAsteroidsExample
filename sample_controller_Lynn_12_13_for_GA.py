...
class FuzzyController(ControllerBase):
    ...
    def __init__(self, chromosome):
        ...
        Plane_Thrust['neg_large'] = fuzz.trimf(Plane_Thrust.universe,
                                               [min_bound_thrust, min_bound_thrust, -thrust_interval])
        ...
        rule1 = ctrl.Rule(Asteroid_Angle_from_plane['neg_small'] & Asteroid_Distance['small'], consequent=(
        Plane_Rotation[rotation_strings[0]], Plane_Thrust[thrust_strings[0]], Plane_Shooting[shoot_strings[0]]),
                          label='rule 1')
        rule2 = ctrl.Rule(Asteroid_Angle_from_plane['neg_small'] & Asteroid_Distance['medium'], consequent=(
        Plane_Rotation[rotation_strings[1]], Plane_Thrust[thrust_strings[1]], Plane_Shooting[shoot_strings[1]]),
                          label='rule 2')
        rule3 = ctrl.Rule(Asteroid_Angle_from_plane['neg_small'] & Asteroid_Distance['large'], consequent=(
        Plane_Rotation[rotation_strings[2]], Plane_Thrust[thrust_strings[2]], Plane_Shooting[shoot_strings[2]]),
                          label='rule 3')

        rule4 = ctrl.Rule(Asteroid_Angle_from_plane['neg_medium'] & Asteroid_Distance['small'], consequent=(
        Plane_Rotation[rotation_strings[3]], Plane_Thrust[thrust_strings[3]], Plane_Shooting[shoot_strings[3]]),
                          label='rule 4')
        rule5 = ctrl.Rule(Asteroid_Angle_from_plane['neg_medium'] & Asteroid_Distance['medium'], consequent=(
        Plane_Rotation[rotation_strings[4]], Plane_Thrust[thrust_strings[4]], Plane_Shooting[shoot_strings[4]]))
        rule6 = ctrl.Rule(Asteroid_Angle_from_plane['neg_medium'] & Asteroid_Distance['large'], consequent=(
        Plane_Rotation[rotation_strings[5]], Plane_Thrust[thrust_strings[5]], Plane_Shooting[shoot_strings[5]]))

        rule7 = ctrl.Rule(Asteroid_Angle_from_plane['neg_large'] & Asteroid_Distance['small'], consequent=(
        Plane_Rotation[rotation_strings[6]], Plane_Thrust[thrust_strings[6]], Plane_Shooting[shoot_strings[6]]))
        rule8 = ctrl.Rule(Asteroid_Angle_from_plane['neg_large'] & Asteroid_Distance['medium'], consequent=(
        Plane_Rotation[rotation_strings[7]], Plane_Thrust[thrust_strings[7]], Plane_Shooting[shoot_strings[7]]))
        rule9 = ctrl.Rule(Asteroid_Angle_from_plane['neg_large'] & Asteroid_Distance['large'], consequent=(
        Plane_Rotation[rotation_strings[8]], Plane_Thrust[thrust_strings[8]], Plane_Shooting[shoot_strings[8]]))

        rule10 = ctrl.Rule(Asteroid_Angle_from_plane['small'] & Asteroid_Distance['small'], consequent=(
        Plane_Rotation[rotation_strings[9]], Plane_Thrust[thrust_strings[9]], Plane_Shooting[shoot_strings[9]]))
        rule11 = ctrl.Rule(Asteroid_Angle_from_plane['small'] & Asteroid_Distance['medium'], consequent=(
        Plane_Rotation[rotation_strings[10]], Plane_Thrust[thrust_strings[10]], Plane_Shooting[shoot_strings[10]]))
        rule12 = ctrl.Rule(Asteroid_Angle_from_plane['small'] & Asteroid_Distance['large'], consequent=(
        Plane_Rotation[rotation_strings[11]], Plane_Thrust[thrust_strings[11]], Plane_Shooting[shoot_strings[11]]))

        rule13 = ctrl.Rule(Asteroid_Angle_from_plane['medium'] & Asteroid_Distance['small'], consequent=(
        Plane_Rotation[rotation_strings[12]], Plane_Thrust[thrust_strings[12]], Plane_Shooting[shoot_strings[12]]))
        rule14 = ctrl.Rule(Asteroid_Angle_from_plane['medium'] & Asteroid_Distance['medium'], consequent=(
        Plane_Rotation[rotation_strings[13]], Plane_Thrust[thrust_strings[13]], Plane_Shooting[shoot_strings[13]]))
        rule15 = ctrl.Rule(Asteroid_Angle_from_plane['medium'] & Asteroid_Distance['large'], consequent=(
        Plane_Rotation[rotation_strings[14]], Plane_Thrust[thrust_strings[14]], Plane_Shooting[shoot_strings[14]]))

        rule16 = ctrl.Rule(Asteroid_Angle_from_plane['large'] & Asteroid_Distance['small'], consequent=(
        Plane_Rotation[rotation_strings[15]], Plane_Thrust[thrust_strings[15]], Plane_Shooting[shoot_strings[15]]))
        rule17 = ctrl.Rule(Asteroid_Angle_from_plane['large'] & Asteroid_Distance['medium'], consequent=(
        Plane_Rotation[rotation_strings[16]], Plane_Thrust[thrust_strings[16]], Plane_Shooting[shoot_strings[16]]))
        rule18 = ctrl.Rule(Asteroid_Angle_from_plane['large'] & Asteroid_Distance['large'], consequent=(
        Plane_Rotation[rotation_strings[17]], Plane_Thrust[thrust_strings[17]], Plane_Shooting[shoot_strings[17]]))
